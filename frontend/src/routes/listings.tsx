      ...
      <main className="flex-1 mx-auto max-w-6xl w-full px-6 py-10">
        ...
        <div className="mb-6 grid gap-3 md:grid-cols-2">
          <input
            ...
            placeholder="Search by City (ex: La Marsa)"
            className="rounded-xl border border-border bg-surface/40 px-4 py-3 text-sm outline-none focus:border-secondary/50 transition-all"
          />
          <input
            value={propertyType}
            onChange={(e) => {
            ...
            placeholder="Property type (ex: Apartment)"
            className="rounded-xl border border-border bg-surface/40 px-4 py-3 text-sm outline-none focus:border-secondary/50 transition-all"
          />
        </div>
